...
console.log('Pезультат с 2 знаками после запятой:', decimal2);
...
// +=
    myTest+=myNum;
    console.log('20+=10:', myTest);
// –=
    myTest-=myNum;
    console.log('30-=10:',myTest);
// *=
    myTest*=myNum;
    console.log('20*=10:',myTest);
// /=
    myTest/=myNum;
    console.log('200/=10:',myTest);
// %=
    myTest%=myNum;
    console.log('20%=10:',myTest);
